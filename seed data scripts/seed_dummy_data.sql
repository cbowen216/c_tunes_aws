...
--SQL Script to reset the tables with dummy data
--if database already exists this WILL 
--ERASE any changes and set back to a default state

-- use the following in the termainal to run this script
'''

cat seed_dummy_data.sql | docker exec -i pg_container psql
